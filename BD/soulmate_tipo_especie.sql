...
--
-- Table structure for table `tipo_especie`
--
...
--
-- Dumping data for table `tipo_especie`
--

LOCK TABLES `tipo_especie` WRITE;
/*!40000 ALTER TABLE `tipo_especie` DISABLE KEYS */;
INSERT INTO `tipo_especie` VALUES (1,'Perro'),(2,'Gato');
/*!40000 ALTER TABLE `tipo_especie` ENABLE KEYS */;
UNLOCK TABLES;
