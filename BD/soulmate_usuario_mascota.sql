...
--
-- Table structure for table `usuario_mascota`
--
...
CREATE TABLE `usuario_mascota` (
  ...
  `idmascota` int unsigned DEFAULT NULL,
  PRIMARY KEY (`idusuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `usuario_mascota`
--

LOCK TABLES `usuario_mascota` WRITE;
/*!40000 ALTER TABLE `usuario_mascota` DISABLE KEYS */;
/*!40000 ALTER TABLE `usuario_mascota` ENABLE KEYS */;
UNLOCK TABLES;
